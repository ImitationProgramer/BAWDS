...
public class Q5 {
    public static class IntQueue {
        ...
        // 큐에 데이터를 인큐
        public int enque(int x) throws chap04.IntQueue.OverflowIntQueueException {
            if (num >= capacity)
        ...
        // 큐에서 데이터를 디큐
        public int deque() throws chap04.IntQueue.EmptyIntQueueException {
            if (num <= 0)
        ...
        public int peek() throws chap04.IntQueue.EmptyIntQueueException {
            if (num <= 0)
                throw new IntQueue.EmptyIntQueueException(); // 큐가 비어 있음
            return que[front];
        }
